...
export default function Main() {
    return (
        <div>
            <SpeedInsights />
            <h1 className="text-7xl flex justify-center items-center max-w-3xl text-classicWhite my-36 mx-10 myfont md:mx-auto">Luke is a student from Stevens who likes to code</h1>
