...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "n8n Ollama driven Agent that customizes Typst resumes for job applications from a Notion job tracker database.",
    technologies: ["Python", "Ollama", "n8n", "Notion API", "Llama 3.2"],
