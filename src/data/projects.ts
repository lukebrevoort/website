...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Python', 'SHIFT', 'Backtrader', 'Market Making', 'Momentum Arbitrage', 'Algorithm Development'],
    slug: 'hftc',
    status: 'completed',
  ...
  },
  {
    ...
    technologies: ['Python', 'Ollama', 'LaTeX', 'Open Source', 'Llama 3.2', 'Notion API'],
