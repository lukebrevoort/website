    ...
    >
        ...
        >
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="space-y-4 text-sm text-slate-600 sm:text-base">
              ...
              <p>
                The result is a repeatable application loop: less manual searching, faster first drafts, and a
                consistent review gate so outputs stay accurate and on-brand.
              </p>
            </div>
          <ProjectMedia
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-600 sm:text-base">
            The workflow is designed for safe automation: strong defaults, review checkpoints, and clear provenance
            from job posting to extracted skills to a generated resume draft.
          </p>
      ...
      >
        <ProjectStatGrid
          items={[
            ...
            { label: "Personalization", value: "Role-fit", description: "Two-pass LLM workflow emphasizes relevant skills." },
          ]}
        />
      </ProjectSection>
