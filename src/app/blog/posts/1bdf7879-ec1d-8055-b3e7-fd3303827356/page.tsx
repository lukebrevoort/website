...
maybe ill make this page one day
...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bdf7879-ec1d-8055-b3e7-fd3303827356')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>How I made the blog!</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>How I made the blog!</h1>
              <time className="text-gray-500">3/19/2025</time>
            </header>
