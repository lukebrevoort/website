...
export default function BlogPost() {
  ...
  const [content, setContent] = useState(`# This is IT!!!!
...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bdf7879-ec1d-8073-b886-d8dfd7999b84')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>The moment of truth!</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>The moment of truth!</h1>
