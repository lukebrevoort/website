...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bbf7879-ec1d-8017-bb68-cc8af95b0ed9')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>This is a super cool thing!</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>This is a super cool thing!</h1>
