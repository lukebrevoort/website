...
export default function BlogPost() {
  ...
  const [content, setContent] = useState(`# More Details 
...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bbf7879-ec1d-80d8-9198-c968115d62cb')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>A Third Blog</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>A Third Blog</h1>
              <time className="text-gray-500">3/18/2025</time>
            </header>
