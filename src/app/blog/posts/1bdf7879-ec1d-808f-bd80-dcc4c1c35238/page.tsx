...
export default function BlogPost() {
  ...
  const [content, setContent] = useState(`# pls
...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bdf7879-ec1d-808f-bd80-dcc4c1c35238')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>Another new thing</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>Another new thing</h1>
