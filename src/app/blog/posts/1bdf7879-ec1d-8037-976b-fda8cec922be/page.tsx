...
export default function BlogPost() {
  ...
  const [content, setContent] = useState(`# Just get something
...
`);
  ...
  useEffect(() => {
    ...
    fetch('/api/image-map?postId=1bdf7879-ec1d-8037-976b-fda8cec922be')
      .then(res => res.json())
      .then(imageMap => {
        ...
        <SidebarInset>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbSeparator />
                  <BreadcrumbItem>
                    <BreadcrumbLink>The final post</BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          ...
          >
            <header className="mb-10">
              <h1 className={`${lukesFont.className} text-4xl font-bold mb-3`}>The final post</h1>
